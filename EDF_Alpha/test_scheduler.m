...
for data_point = 1:2:N    
    for sim_instance = 1:S        
        ...
        results_throughput.max_weight{current_data_point,sim_instance}.val = no_dropping_val/max_weight_val;
        results_throughput.edf_alpha{current_data_point,sim_instance}.val = no_dropping_val/edf_alpha_val;
        results_throughput.edf{current_data_point,sim_instance}.val = no_dropping_val/edf_val;
        results_throughput.fcfs_sj{current_data_point,sim_instance}.val = no_dropping_val/fcfs_val_sj;
